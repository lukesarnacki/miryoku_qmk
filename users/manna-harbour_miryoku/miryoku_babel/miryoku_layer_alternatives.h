...
#define MIRYOKU_ALTERNATIVES_BASE_QWERTY_NIX \
KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,              KC_Y,              KC_U,              KC_I,              KC_O,              KC_P,              \
GUI_A,             ALT_S,             CTL_D,             SFT_F,             AGR_G,            AGR_H,              SFT_J,             CTL_K,             ALT_L,             GUI_SCLN,           \
LT(U_BUTTON,KC_Z), ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    LT(U_BUTTON,KC_SLSH),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_BSPC), LT(U_FUN,KC_TAB),  LT(U_NUM,KC_ENT), LT(U_SYM,KC_SPC),   LT(U_MOUSE,KC_DEL),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY_MAC \
KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,              KC_Y,              KC_U,              KC_I,              KC_O,              KC_P,              \
CTL_A,             ALT_S,             GUI_D,             SFT_F,             AGR_G,            AGR_H,              SFT_J,             GUI_K,             ALT_L,             CTL_SCLN,           \
LT(U_BUTTON,KC_Z), ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    LT(U_BUTTON,KC_SLSH),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_BSPC), LT(U_FUN,KC_TAB),  LT(U_NUM,KC_ENT), LT(U_SYM,KC_SPC),   LT(U_MOUSE,KC_DEL),U_NP,              U_NP
...
KC_WH_D,           KC_MS_L,           KC_MS_D,           KC_MS_R,           U_NU,              KC_RALT,           KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
...
KC_LCBR,           KC_AMPR,           KC_ASTR,           KC_PERC,           KC_RCBR,           U_NA,              TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
KC_PLUS,           KC_CIRC,           KC_MINS,           KC_UNDS,           KC_DLR,           KC_RALT,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
KC_TILD,           KC_EXLM,           KC_AT,             KC_HASH,           KC_PIPE,           U_NA,              TD(U_TD_U_SYM),    TD(U_TD_U_MOUSE),  KC_ALGR,           U_NA,              \
U_NP,              U_NP,              KC_LPRN,           KC_RPRN,           KC_DQT,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP


#define MIRYOKU_ALTERNATIVES_NUM \
KC_LBRC,           KC_7,              KC_8,              KC_9,              KC_RBRC,           U_NA,              TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
KC_EQL,            KC_4,              KC_5,              KC_6,              KC_0,            KC_RALT,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
KC_GRV,            KC_1,              KC_2,              KC_3,              KC_BSLS,           U_NA,              TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    KC_ALGR,           U_NA,              \
U_NP,              U_NP,              KC_LCBR,           KC_RCBR,           KC_QUOT,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
